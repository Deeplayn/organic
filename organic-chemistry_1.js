...
const mols={
  ...
  ethylacetate:{name:'Ethyl Acetate',formula:'C4H8O2',info:'A common ester that ties together carbonyl chemistry, resonance, and hydrolysis pathways.',insight:'Esters are resonance-stabilized yet still reactive enough for hydrolysis and transesterification.',prompt:'Review why esters react differently from acids, aldehydes, and ketones.',draw(s){const[a,a2,td,t,c]=[cv('--accent'),cv('--accent3'),cv('--text-dim'),cv('--text'),cv('--card')];s.innerHTML=`<circle cx="48" cy="100" r="16" fill="${c}" stroke="${td}" stroke-width="1.5"/><text x="48" y="100" text-anchor="middle" dominant-baseline="central" fill="${t}" font-family="monospace" font-size="9">CH3</text><line x1="64" y1="100" x2="104" y2="100" stroke="${a}" stroke-width="3" stroke-linecap="round"/><line x1="108" y1="95" x2="145" y2="72" stroke="${a2}" stroke-width="2.2" stroke-linecap="round"/><line x1="114" y1="101" x2="151" y2="78" stroke="${a2}" stroke-width="2.2" stroke-linecap="round"/><circle cx="157" cy="75" r="14" fill="${c}" stroke="${a2}" stroke-width="1.5"/><text x="157" y="75" text-anchor="middle" dominant-baseline="central" fill="${a2}" font-family="monospace" font-size="10">O</text><line x1="112" y1="100" x2="160" y2="100" stroke="${a}" stroke-width="3" stroke-linecap="round"/><circle cx="176" cy="100" r="14" fill="${c}" stroke="${a}" stroke-width="1.5"/><text x="176" y="100" text-anchor="middle" dominant-baseline="central" fill="${a}" font-family="monospace" font-size="10">O</text><line x1="190" y1="100" x2="226" y2="100" stroke="${a}" stroke-width="3" stroke-linecap="round"/><circle cx="236" cy="100" r="16" fill="${c}" stroke="${td}" stroke-width="1.5"/><text x="236" y="100" text-anchor="middle" dominant-baseline="central" fill="${t}" font-family="monospace" font-size="9">CH2</text><text x="136" y="145" text-anchor="middle" fill="${td}" font-family="monospace" font-size="9">ester linkage</text>`;}},
